...
function drawPage(){
    ...
    for (let i = 0; i < boards.length; i++){
        ...
        result +=
            ...
            "<div class='card'>" +
            "<div class='card-header'><h3 onclick='edit("+ i +")'>"+ boards[i].title +"</h3></div>" +
...
function addTask(index) {
    let taskTiles = document.getElementById(`task-title` + index).value;
    boards[index].tasks.push(taskTiles);
    drawPage();
}
